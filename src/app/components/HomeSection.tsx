...
export default function HomeSection() {
  return (
    <section id="home" className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-900 scroll-mt-20">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        >
          <Image
            ...
            width={320}
            height={320}
            className="rounded-full object-cover border-4 border-white dark:border-gray-800 shadow-xl z-10"
          />
        </motion.div>
      </div>
    </section>
